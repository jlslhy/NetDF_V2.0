...
namespace WEB.DataAccess.WF_NodeTBL
{
    ...
    public class GetData : GetDataBase, IHttpHandler,System.Web.SessionState.IRequiresSessionState
    {
        ...
        DBControl.DBInfo.Tables.WF_Node tableInfo = new DBControl.DBInfo.Tables.WF_Node();
        ...
        public void GetDataList()
        {
            ...
            string condition = MakeConditionString<DBControl.DBInfo.Tables.WF_Node>(HttpContext.Current, "s_");
            ...
            try
            {
                ...
                switch (selectType)
                {
                    case enumSelectType.FirstPage:
                        idr = DBControl.Base.DBAccess.GetFirstPageDataIDR<DBControl.DBInfo.Tables.WF_Node>(fieldArr.ToString(","), _descOrder, _pageSize, condition);
                        break;
                    case enumSelectType.LastPage:
                        idr = DBControl.Base.DBAccess.GetLastPageDataIDR<DBControl.DBInfo.Tables.WF_Node>(fieldArr.ToString(","), _descOrder, _pageSize, condition);
                        break;
                    case enumSelectType.PrevPage:
                        idr = DBControl.Base.DBAccess.GetPrevPageDataIDR<DBControl.DBInfo.Tables.WF_Node>(fieldArr.ToString(","), _descOrder, _pageSize, _minid, _maxid, condition);
                        break;
                    case enumSelectType.NextPage:
                        idr = DBControl.Base.DBAccess.GetNextPageDataIDR<DBControl.DBInfo.Tables.WF_Node>(fieldArr.ToString(","), _descOrder, _pageSize, _minid, _maxid, condition);
                        break;
                    case enumSelectType.GoToPage:
                        idr = DBControl.Base.DBAccess.GetPageDataIDR<DBControl.DBInfo.Tables.WF_Node>(fieldArr.ToString(","), _descOrder, _pageSize, _page, condition);
                        break;
                ...
                if (jArray.Count > 0)
                {
                    ...
                    if (IsGetTotal)
                    {
                        _total = DBControl.Base.DBAccess.Count<DBControl.DBInfo.Tables.WF_Node>(condition);
                    }
