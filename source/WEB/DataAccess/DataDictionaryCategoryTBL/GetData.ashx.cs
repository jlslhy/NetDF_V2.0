...
namespace WEB.DataAccess.DataDictionaryCategoryTBL
{
    /// <summary>
    /// GetData 的摘要说明
    /// </summary>
    ...
    {
        DBControl.Base.BLLOpt<Model.DataDictionaryCategory_Model> Bll = new DBControl.Base.BLLOpt<Model.DataDictionaryCategory_Model>();
        DBControl.DBInfo.Tables.DataDictionaryCategory tableInfo = new DBControl.DBInfo.Tables.DataDictionaryCategory();
        public void ProcessRequest(HttpContext context)
        {
            /********  初始化 Start  ********/
            _tableName = "DataDictionaryCategory";
            _orderBy = "ID asc";
            _idField = "ID";
        ...
        public void GetDataList()
        {
            ...
            string condition = MakeConditionString<DBControl.DBInfo.Tables.DataDictionaryCategory>(HttpContext.Current, "s_");
            ...
            try
            {
                ...
                switch (selectType)
                {
                    case enumSelectType.FirstPage:
                        idr = DBControl.Base.DBAccess.GetFirstPageDataIDR<DBControl.DBInfo.Tables.DataDictionaryCategory>(fieldArr.ToString(","), _descOrder, _pageSize, condition);
                        break;
                    case enumSelectType.LastPage:
                        idr = DBControl.Base.DBAccess.GetLastPageDataIDR<DBControl.DBInfo.Tables.DataDictionaryCategory>(fieldArr.ToString(","), _descOrder, _pageSize, condition);
                        break;
                    case enumSelectType.PrevPage:
                        idr = DBControl.Base.DBAccess.GetPrevPageDataIDR<DBControl.DBInfo.Tables.DataDictionaryCategory>(fieldArr.ToString(","), _descOrder, _pageSize, _minid, _maxid, condition);
                        break;
                    case enumSelectType.NextPage:
                        idr = DBControl.Base.DBAccess.GetNextPageDataIDR<DBControl.DBInfo.Tables.DataDictionaryCategory>(fieldArr.ToString(","), _descOrder, _pageSize, _minid, _maxid, condition);
                        break;
                    case enumSelectType.GoToPage:
                        idr = DBControl.Base.DBAccess.GetPageDataIDR<DBControl.DBInfo.Tables.DataDictionaryCategory>(fieldArr.ToString(","), _descOrder, _pageSize, _page, condition);
                        break;
                ...
                if (jArray.Count > 0)
                {
                    ...
                    if (IsGetTotal)
                    {
                        _total = DBControl.Base.DBAccess.Count<DBControl.DBInfo.Tables.DataDictionaryCategory>(condition);
                    }
