...
namespace WEB.DataAccess.DataDictionaryCategoryTBL
{
    ...
    public class OperateData : OperateDataBase, IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        // DBControl.BLL.DataDictionaryCategoryBLL bllExt = new DBControl.BLL.DataDictionaryCategoryBLL();
        ...
        {
            /********   可修改区域 Start  ********/
            Model.DataDictionaryCategory_Model model = GetNewDataModel(CurrentContext);
            /********   可修改区域 End  ********/
        ...
        /********  获取数据  可修改区域 Start  ********/
        private Model.DataDictionaryCategory_Model GetNewDataModel(HttpContext context)
        {
            Model.DataDictionaryCategory_Model model = new Model.DataDictionaryCategory_Model();
            if (IsEdit)
            {
            ...
            model.CategoryName = UrlHelper.ReqStrByGetOrPost(context, "CategoryName");
