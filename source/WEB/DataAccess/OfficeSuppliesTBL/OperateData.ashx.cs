...
namespace WEB.DataAccess.OfficeSuppliesTBL
{
    ...
    public class OperateData : OperateDataBase, IHttpHandler,System.Web.SessionState.IRequiresSessionState
    {
        ...
        DBControl.BLL.WEB.OfficeSuppliesBLL bllAddition = new DBControl.BLL.WEB.OfficeSuppliesBLL();
	    
	   // DBControl.BLL.OfficeSuppliesBLL bllExt = new DBControl.BLL.OfficeSuppliesBLL();
        ...
        {
            /********   可修改区域 Start  ********/
            Model.WEB.OfficeSupplies_Model model = GetNewDataModel(CurrentContext);
            /********   可修改区域 End  ********/
        ...
        /********  获取数据  可修改区域 Start  ********/
        private Model.WEB.OfficeSupplies_Model GetNewDataModel(HttpContext context)
        {
            Model.WEB.OfficeSupplies_Model model = new Model.WEB.OfficeSupplies_Model();
            if (IsEdit)
            {
            ...
            model.Code = UrlHelper.ReqStrByGetOrPost(context, "Code");
			
            model.GoodsName = UrlHelper.ReqStrByGetOrPost(context, "GoodsName");
			
            model.GoodsCateogory = UrlHelper.ReqStrByGetOrPost(context, "GoodsCateogory");
			
            model.Specification = UrlHelper.ReqStrByGetOrPost(context, "Specification");
			
            model.Unit = UrlHelper.ReqStrByGetOrPost(context, "Unit");
			
            model.IndicativePrice = UrlHelper.ReqDecimalByGetOrPost(context, "IndicativePrice");
