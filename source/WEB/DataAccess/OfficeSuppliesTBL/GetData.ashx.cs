...
namespace WEB.DataAccess.OfficeSuppliesTBL
{
    /// <summary>
    /// GetData 的摘要说明
    /// </summary>
    ...
    {
        DBControl.Base.BLLOpt<Model.WEB.OfficeSupplies_Model> Bll = new DBControl.Base.BLLOpt<Model.WEB.OfficeSupplies_Model>();
        DBControl.DBInfo.Tables.WEB.OfficeSupplies tableInfo = new DBControl.DBInfo.Tables.WEB.OfficeSupplies();
        public void ProcessRequest(HttpContext context)
        {
            /********  初始化 Start  ********/
            _tableName = "OfficeSupplies";
            _orderBy = "ID asc";
            _idField = "ID";
        ...
        public void GetDataList()
        {
            ...
            string condition = MakeConditionString<DBControl.DBInfo.Tables.WEB.OfficeSupplies>(HttpContext.Current, "s_");
            ...
            try
            {
                ...
                switch (selectType)
                {
                    case enumSelectType.FirstPage:
                        idr = DBControl.Base.DBAccess.GetFirstPageDataIDR<DBControl.DBInfo.Tables.WEB.OfficeSupplies>(fieldArr.ToString(","), _descOrder, _pageSize, condition);
                        break;
                    case enumSelectType.LastPage:
                        idr = DBControl.Base.DBAccess.GetLastPageDataIDR<DBControl.DBInfo.Tables.WEB.OfficeSupplies>(fieldArr.ToString(","), _descOrder, _pageSize, condition);
                        break;
                    case enumSelectType.PrevPage:
                        idr = DBControl.Base.DBAccess.GetPrevPageDataIDR<DBControl.DBInfo.Tables.WEB.OfficeSupplies>(fieldArr.ToString(","), _descOrder, _pageSize, _minid, _maxid, condition);
                        break;
                    case enumSelectType.NextPage:
                        idr = DBControl.Base.DBAccess.GetNextPageDataIDR<DBControl.DBInfo.Tables.WEB.OfficeSupplies>(fieldArr.ToString(","), _descOrder, _pageSize, _minid, _maxid, condition);
                        break;
                    case enumSelectType.GoToPage:
                        idr = DBControl.Base.DBAccess.GetPageDataIDR<DBControl.DBInfo.Tables.WEB.OfficeSupplies>(fieldArr.ToString(","), _descOrder, _pageSize, _page, condition);
                        break;
                ...
                if (jArray.Count > 0)
                {
                    ...
                    if (IsGetTotal)
                    {
                        _total = DBControl.Base.DBAccess.Count<DBControl.DBInfo.Tables.WEB.OfficeSupplies>(condition);
                    }
