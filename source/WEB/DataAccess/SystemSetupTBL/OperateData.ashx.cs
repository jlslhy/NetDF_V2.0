...
namespace WEB.DataAccess.SystemSetupTBL
{
    ...
    public class OperateData : OperateDataBase, IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        // DBControl.BLL.SystemSetupBLL bllExt = new DBControl.BLL.SystemSetupBLL();
        ...
        {
            /********   可修改区域 Start  ********/
            Model.SystemSetup_Model model = GetNewDataModel(CurrentContext);
            /********   可修改区域 End  ********/
        ...
        /********  获取数据  可修改区域 Start  ********/
        private Model.SystemSetup_Model GetNewDataModel(HttpContext context)
        {
            Model.SystemSetup_Model model = new Model.SystemSetup_Model();
            if (IsEdit)
            {
            ...
            model.KeyCode = UrlHelper.ReqStrByGetOrPost(context, "KeyCode");

            model.SetupValue = UrlHelper.ReqStrByGetOrPost(context, "SetupValue");

            model.SetupType = UrlHelper.ReqStrByGetOrPost(context, "SetupType");
