...
namespace Common
{
    ...
    public class UrlOper
    {
        ...
        {
            if (null == HttpContext.Current.Request.QueryString[par])
            {
                return string.Empty;
            }
            else {
        ...
        public static string ReqFormStr(string par)
        {
            if (null == HttpContext.Current.Request.Form[par])
            {
                return string.Empty;
            }
            else
            {
                return HttpContext.Current.Request.Form[par].ToString();
            }
        }


        public static int ReqFormInt(string par)
        {
            string val = ReqFormStr(par);
            int i;
            if (Int32.TryParse(val, out i))
            {
                return i;
