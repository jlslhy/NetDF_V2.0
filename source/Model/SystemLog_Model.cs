...
namespace Model
{
    public class SystemLog_Model:Model.Base.ModelBase
    {
        ...
        { get
           ...
           ( [LogClass],[LogTitle],[LogContent],[CreateTime],[Operator]) VALUES (@LogClass,@LogTitle,@LogContent,@CreateTime,@Operator);select @@identity ";}}
        ...
        { get
            {
                ...
                list.Add(new SqlParameter("@LogID", M_LogID));
                return list.ToArray();}}
